...
from flask_openapi.constants import DEFAULT_BUNDLE_JS, DEFAULT_CSS, DEFAULT_FAVICON, DEFAULT_JQUERY, DEFAULT_PRESET_JS
...
class APIDocsView(MethodView):
    ...
    def get(self) -> Union[Response, str, tuple[str, int, dict[str, str]]]:
        ...
        if is_auth:
            ...
            data: dict = {"specs": specs, "urls": urls, "title": self.config.get('title', 'API Docs')}
